 ...
 */
public class LightBlueGlowstone extends Block{

    public LightBlueGlowstone(Material materialIn) {
        super(materialIn, MapColor.LIGHT_BLUE);

        setUnlocalizedName("BlockLightBlueGlowstone");
        setRegistryName("BlockLightBlueGlowstone");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ModItems.lightblueglowstonedust;
    }

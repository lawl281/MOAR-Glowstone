...
public class MagentaGlowstone extends Block{
    ...
    public MagentaGlowstone(Material materialIn) {
        super(materialIn, MapColor.MAGENTA);

        setUnlocalizedName("BlockMagentaGlowstone");
        setRegistryName("BlockMagentaGlowstone");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ModItems.magentaglowstonedust;
    }

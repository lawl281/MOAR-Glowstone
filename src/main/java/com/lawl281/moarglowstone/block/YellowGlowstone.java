...
public class YellowGlowstone extends Block{
    ...
    public YellowGlowstone(Material materialIn) {
        super(materialIn, MapColor.YELLOW);

        setUnlocalizedName("BlockYellowGlowstone");
        setRegistryName("BlockYellowGlowstone");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ModItems.yellowglowstonedust;
    }

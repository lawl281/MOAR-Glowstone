...
public class LimeGlowstone extends Block{
    ...
    public LimeGlowstone(Material materialIn) {
        super(materialIn, MapColor.LIME);

        setUnlocalizedName("BlockLimeGlowstone");
        setRegistryName("BlockLimeGlowstone");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ModItems.limeglowstonedust;
    }

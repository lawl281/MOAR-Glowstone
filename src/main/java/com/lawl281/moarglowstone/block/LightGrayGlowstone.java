 ...
 */
public class LightGrayGlowstone extends Block{

    public LightGrayGlowstone(Material materialIn) {
        super(materialIn, MapColor.SILVER);

        setUnlocalizedName("BlockLightGrayGlowstone");
        setRegistryName("BlockLightGrayGlowstone");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ModItems.lightgrayglowstonedust;
    }

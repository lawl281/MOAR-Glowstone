...
public class WhiteGlowstone extends Block{
    ...
    public WhiteGlowstone(Material materialIn) {
        super(materialIn, MapColor.SNOW);

        setUnlocalizedName("BlockWhiteGlowstone");
        setRegistryName("BlockWhiteGlowstone");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ModItems.whiteglowstonedust;
    }

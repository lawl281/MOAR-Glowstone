...
public class OrangeGlowstone extends Block{
    ...
    public OrangeGlowstone(Material materialIn) {
        super(materialIn, MapColor.ADOBE);

        setUnlocalizedName("BlockOrangeGlowstone");
        setRegistryName("BlockOrangeGlowstone");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ModItems.orangeglowstonedust;
    }

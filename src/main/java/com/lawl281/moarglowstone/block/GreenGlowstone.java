...
public class GreenGlowstone extends Block{
    ...
    public GreenGlowstone(Material materialIn) {
        super(materialIn, MapColor.GREEN);

        setUnlocalizedName("BlockGreenGlowstone");
        setRegistryName("BlockGreenGlowstone");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {return ModItems.greenglowstonedust;
    }

...
public class CyanGlowstone extends Block{
    ...
    public CyanGlowstone(Material materialIn) {
        super(materialIn, MapColor.CYAN);

        setUnlocalizedName("BlockCyanGlowstone");
        setRegistryName("BlockCyanGlowstone");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ModItems.cyanglowstonedust;
    }

...
public class PurpleGlowstone extends Block{
    ...
    public PurpleGlowstone(Material materialIn) {
        super(materialIn, MapColor.PURPLE);

        setUnlocalizedName("BlockPurpleGlowstone");
        setRegistryName("BlockPurpleGlowstone");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ModItems.purpleglowstonedust;
    }

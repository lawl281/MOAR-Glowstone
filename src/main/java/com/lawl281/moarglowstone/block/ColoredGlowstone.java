 ...
 */
public class ColoredGlowstone extends Block{

   // public static final String[] colors = {"Black", "Blue", "Brown", "Cyan", "Gray", "Green", "LightBlue", "LightGray", "Magenta", "Orange", "Pink", "Purple", "Red", "White", "Yellow",};

    public ColoredGlowstone(Material materialIn) {
        super(materialIn, MapColor.BLACK);

        setUnlocalizedName("BlockBlackGlowstone");
        setRegistryName("BlockBlackGlowstone");

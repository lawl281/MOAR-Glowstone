...
public class PinkGlowstone extends Block{
    ...
    public PinkGlowstone(Material materialIn) {
        super(materialIn, MapColor.PINK);

        setUnlocalizedName("BlockPinkGlowstone");
        setRegistryName("BlockPinkGlowstone");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ModItems.pinkglowstonedust;
    }

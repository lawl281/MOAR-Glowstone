...
/**
 * Created by lawl281 on 10/8/2016.
 */
public class CarvedGlowstoneBrick extends Block implements IMetaBlockName {
    public static final PropertyEnum COLOR = PropertyEnum.create("color", ColorEnum.class);

    public CarvedGlowstoneBrick(Material materialIn) {
        super(materialIn);

        this.setUnlocalizedName("carvedglowstonebrick");
        this.setRegistryName("carvedglowstoneBrick");
